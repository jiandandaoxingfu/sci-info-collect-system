class Paper {
	...
	cite_refined_page() {
		...
		for( let div of document.querySelectorAll('div.search-results-item') ) {
			...
			let author_union = new Set( [...authors, ...this.author ] );
			if( author_union.size === (authors.length + this.author.length) ) {
